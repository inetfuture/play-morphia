...
The PlayMorphia module a powerful and yet easy to use framework that gprovides "MongoDB":http://www.mongodb.org/ access to your Play!framework application. This module is built on top of the famous "Morphia project":https://github.com/mongodb/morphia.
